...
const donorKey = (name:string) => name.trim().replace(/^mr\.?\s+/i,'').replace(/\s+/g,' ').toLowerCase()||'not provided'
const donorDisplayName = (name:string) => name.trim().replace(/^mr\.?\s+/i,'').replace(/\s+/g,' ')||'Not provided'
