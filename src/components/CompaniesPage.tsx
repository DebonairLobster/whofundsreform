...
export function CompaniesPage({data}:{data:Donation[]}){
  ...
  useEffect(()=>{
    ...
    const frame=requestAnimationFrame(()=>{
      ...
      details.querySelector<HTMLElement>('h2')?.focus({preventScroll:true})
    })
